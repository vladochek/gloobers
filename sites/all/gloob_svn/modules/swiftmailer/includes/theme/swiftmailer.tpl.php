...
<html><head><title></title><meta content="text/html; charset=utf-8" http-equiv="Content-Type"><meta content="width=320, target-densitydpi=device-dpi" name="viewport">
<style type="text/css">
...
body { background-color: #fcfcfc; margin: 0; padding: 0; }
...
#background-table { background-color: #fcfcfc; }
...
.article-title { font-size: 18px; line-height:24px; color: #9a9661; font-weight:bold; margin-top:0px; margin-bottom:18px; font-family: 'Lucida Grande', 'Lucida Sans Unicode', Verdana, sans-serif; }
...
<![endif]--></head>
<body>
<table align="center" width="674px" style="font-family:Tahoma, Geneva, sans-serif; background:#f4f4f4; width:674px;" border="0" cellpadding="0" cellspacing="0">
	<tbody>
    	<tr>
        	<td style="width:100%; background:#333; text-align:left; padding:10px 10px;">
            	<h1 style="color:#fff; text-transform:uppercase; margin:0;"><img src="http://gloobers.net/sites/default/files/logo.png" /></h1>
            </td>
        </tr>
        <tr>
        ...
        <tr>
        	<td style="padding:20px; text-align:center;">
            	<p style="margin:0; padding:0 20px; padding-top:40px; font-size:12px; color:#606060; text-align:left;">Lorem ipsum dolor sit amet</p> 
				<p style="margin:0; padding:0 20px; font-size:12px; color:#606060; text-align:left;">Duis 512, 210 autem,  Vel Eum </p>
                <p style="margin:0; padding:0 20px; font-size:12px; color:#606060; text-align:left;"><i>© 2014 copyright. All right reserved.</i></p>
            </td>
       </tr>
	</tbody>
</table>
