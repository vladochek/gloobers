              ...
              <div class="table-responsive clearfix">
                <table class="table table-hover">
				  ...
				  ?>
                    <tr>
					<td><?php echo $i;?></td>
                      <td><a href="<?php echo $base_url.'/experience/view/'.$booking['eid'];?>"><?php echo ucfirst($booking['title']); ?></a></td>
                    ...
                    <div class="booking-summry">
                        ...
                        <?php
						 ...
						 if((isset($otherDetails['check-out-date']) && $otherDetails['check-out-date']!="") || (isset($otherDetails['check-out-time']) && $otherDetails['check-out-time'] !=""))
						 {
                         ?> 						 
                            <div class="col-sum half f-right">
                                <label>Departure Date</label>
                                <p><?php echo date("d, F Y",strtotime($otherDetails['check-out-date']))." ".$otherDetails['check-out-time']; ?></p>
                            </div><!-- col ends -->
                           </div><!-- row-sum ends -->
						 <?php
                          }
				...
				/* 								$basePrice = array_search($key[0],$schedulingPriceData);
                  ...
                  <!-------------------------------------------------------------------------------------------------->
							...
							?>
                            	<div class="charg-row">
                                	<p>SUB TOTAL</p>
                                     <span><?php echo '$'.($booking['total_cost']+$booking['additional_cost']);?></span> 
                                </div><!-- row ends -->
                                <?php
								if($booking['security'])
								{	
