...
/* 		var addSession = jq('#session');
		...
		jq('#addInc').on('click', function(e) {
			...
			{
				e.handled=true;
				jq('<div class="amenities-included" id="amenities-included' + i +'"><div class="form-item form-type-textfield form-item-whats-included"><input type="text" maxlength="35" size="60" value="" name="whats_included_extra['+i+']" id="edit-whats-included' + i +'" class="form-control form-text" placeholder="Add label"></div><a class="btn btn-dark btn-gradient form-submit add-extra-submit" href="#" id="remInc">Remove</a></div>').appendTo(addtInc);
				i++;
			}
			return false;
		});
		...
		jq('#remExcExtra').live('click', function() {
