		...
		'<div class="plupload_wrapper">' +
			'<div class="ui-widget-content plupload_container">' +
				...
				'<div class="plupload_content demo">' +
					'<div class="plupload_droptext"><div class="dz-default dz-message"><div class="multi-upload"><span><i class="fa fa-cloud-upload"></i> 		 <span class="main-text"><b>Drop Files</b> to upload</span> <br> 		</span></div>		<div class="uplaod-link"> <a class="plupload_button plupload_add">(or click)</a> </div></div></div>' +
					'<ul class="plupload_filelist_content"> </ul>' +
					'<div class="plupload_clearer">&nbsp;</div>' +
				'</div>' +
				...
				jConfirm("Are you sure you wish to delete this photo? It's a nice one! ", 'Delete Photo', function(r) {
					if (r == true)
					{
						...
						.done(function( data ) {
							...
							$("#"+menuchahidihaiid).parent().append('<span style="color:green;font-size:15px;font-weight:bold;" class="ajax-complete">Deleted</span>');
						});
...
/****************************************************************************************************/
		...
		uploader.bind('UploadComplete', function(up, files,response) {
			...
			$( ".highlights" ).blur(function() {	
				...
				.done(function( data ) {
					$("#"+menuchahidihaiid).parent().find(".ajax-running").hide();
					$("#"+menuchahidihaiid).parent().append('<span style="color:green;font-size:15px;font-weight:bold;" class="ajax-complete">Saved</span>');
				});
			});
