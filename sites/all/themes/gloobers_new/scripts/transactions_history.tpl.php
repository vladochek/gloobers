...
?> 
 ...
 <div class="sidebar_menu">
	 ...
	 <ul>
		...
		<li><a href="<?php echo $base_url.'/transactions/history' ?>">Transactions history </a></li>
              ...
              <div class="table-responsive clearfix">
                <table class="table table-hover">
				  ...
				  ?>
                    <tr>
					<td><?php echo $i;?></td>
                      <td><a href="<?php echo url('experience/'.$booking['lid']);?>"><?php echo ucfirst($booking['title']);?></a></td>
