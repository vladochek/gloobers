    ...
    $.fn.simpleCropper = function (onComplete) {
        ...
        this.click(function () {
            ...
            file_display_area = $(this);
			 /**********My Custom Variable***********/
                file_display_area_id = $(this).attr("id");
                /**********End My Custom Variable***********/
            $('#fileInput').click();
        });
        ...
        $(document).ready(function () {
            ...
            //ok listener
            $('.ok').click(function () {
                var resultVar=preview();
				/*************My Customized Code*******************/
					if(file_display_area_id=='cp'){  var Cp=resultVar;}
					if(file_display_area_id=='dp'){ var Dp=resultVar; }
					if(!Dp){var Dp='0';}
					if(!Cp){var Cp='0';}
                    if(Dp!=0){
                        $("#drop3").find("img").attr("src", Dp);
                    }  
                    if(Cp!=0){
        ...
        function preview() {
			...
			$("#dp").append("<div class='overlaytext'><div class='overprofile_text'><img src='"+$baseUrl+"/sites/all/themes/gloobers_new/images/cover.png' alt='image' />Change the profile picture</div></div>");
			//$("#cp").append("<div class='profile_text'><img src='"+$baseUrl+"/sites/all/theme/gloobers_new/images/cover.png' alt='image' title='' /><br/>Change the cover picture</div>");
