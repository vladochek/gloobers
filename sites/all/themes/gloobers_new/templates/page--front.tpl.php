...
<?php if (!$user->uid) { ?>
                    ...
                    <div class="loginheader">
                        ...
                        <div class="col-md-9 col-sm-6 col-xs-9">
                            ...
                            <div class="logo"><a href="<?php echo $base_url; ?>"><img src="<?php print $GLOBALS['base_url'] . '/' . drupal_get_path('theme', $GLOBALS['theme']); ?>/images/sitelogo.png" alt="" title="" /></a>	</div> <!-- End Logo -->

                        </div> <!-- End Col -->

                        <div class="col-md-3 col-sm-6 col-xs-12 iphonetab">
...
<script type="text/javascript">
                            ...
                            jQuery(window).scroll(function () {
                                ...
                                wHeight = jQuery(window).scrollTop() + jQuery(window).height()+150;
