...
@example
	...
	<script>
		$('.form-type-plupload').plupload({
			url : 'http://staging.gloobers.net/product/add/images',
			filters : [
...
/* 				$.alerts.okButton = ' Yes ';
		...
		uploader.bind('UploadFile', function(up, file) {
			...
			up.settings.multipart_params.customValue = texta;
...
/* 		uploader.bind('BeforeUpload', function(up, file) {
				up.settings.url = 'http://localhost/gloobers/product/add/images?diretorio=full-size',
