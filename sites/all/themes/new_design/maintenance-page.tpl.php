...
<head>
    ...
    <style  type="text/css">
        ...
        *:after {
        ...
        body {
            background: url(<?= $base_path.drupal_get_path('theme', 'gloobers_new') . '/images/bg-coming-soon.jpg' ?>) 50% 0 no-repeat;
...
<div class="wrapper">
    <a href="#" class="logo"><img src="<?= $base_path.drupal_get_path('theme', 'gloobers_new') . '/images/logo01.png' ?>" alt="Gloobers" height="82" width="224"></a>
...
//        var x = document.forms["myForm"]["email"].value;
    ...
    $("body").on("click", "#sendmail", function () {
        var email = $("#lb01").val();
        console.log('https://'+location.hostname+'/comingsoon.php');
        console.log(email);
        if(validateEmail(email)) {
            $.post('https://'+location.hostname+'/comingsoon.php', {email: email}).done(function (data) {
                console.log(data);
            });
        }
    });
