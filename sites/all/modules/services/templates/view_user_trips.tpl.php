				 ...
				 // echo "expireddatetime-------------".$expiredDate."-------------"."currentdatetime---".$Currentdatetime."---------";
				  ...
				  ?>
                    <tr>
					  ...
					  ?>
					  <td class="text-center"><?php echo date("Y-m-d H:i:s",$booking['created']);?> </td>
                      <td  class="text-right">
					  
					  <a class="table-link inline" href="#details<?php echo $booking['id'];?>"> <span class="fa-stack"> View details </span> </a></td>
                    </tr>
					...
					<div class="user-details booking-summry">
                      ...
                      ?>
					   <div class="col-sum half">
					    <label>Company</label>   <p><?php echo $otherDetails['company']."".$otherDetails['last_name'];?></p>
					  </div>
                      <?php
                        }   					  
					  ?>
