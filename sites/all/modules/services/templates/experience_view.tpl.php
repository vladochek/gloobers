...
<div class="tab-block margin-bottom-lg">
				...
				<p><label><b>HighLight - </b></label>    <span><?php echo ($OverviewData['short_description'])? $OverviewData['short_description']: 'NA';?></span>  </p>
  ...
  <div id="additional-services" class="tab-pane">
	 ...
	 <div class="row product-extra">
        ...
        <div class="clearfix"></div>
				  ...
				  <p><b> Experience Requirements - </b><?php 
				  $exp_ruls_details = unserialize($rulesDetail['experience_rules']);
				  $additional_req='';
				  foreach($exp_ruls_details as $exp_ruls_detail){
				  	$additional_req .= $exp_ruls_detail.',';
				  }
				  echo ($additional_req)? rtrim($additional_req,',') :  'NA'; 

				  ?></p>

				  <p><b> Other Information       - </b><?php echo ($rulesDetail['other_information'])? $rulesDetail['other_information'] :  'NA';?></p>

				  <p><span><b>Expected Arrival Time - </b><?php echo ($rulesDetail['expected_arrival_time'])? $rulesDetail['expected_arrival_time'] :  'NA ,'; ?></span>      <span><b>Expected Departure Time - </b></span><?php echo ($rulesDetail['expected_dept_time'])? $rulesDetail['expected_dept_time'] :  'NA'; ?></p>

				  <p><b> Security Deposit        - </b><?php echo ($rulesDetail['security_deposit'])? $rulesDetail['security_deposit'] :  'NA';  
				  if($rulesDetail['security_deposit']){
				  	if($rulesDetail['security_options']=='booking_%'){echo '%';} else echo '$'; 
				  }				  

				  ?></p>

                  <p><b> Cancellation Policies  - </b><?php echo ($rulesDetail['cancellation_policies_type'])? $rulesDetail['cancellation_policies_type'] :  'NA';?></p>
				...
				<p> <?php echo $rulesDetail['amount_day'];?>  (in %) refund of their paid rental costs if they cancel at least <?php echo $rulesDetail['amount_day_rental']." " .$rulesDetail['amount_day_select'];?>  prior to reservation </p>
                  ...
                  <p><b> Agreement           - </b><?php echo ($rulesDetail['agreement'])? $rulesDetail['agreement'] :  'NA';?></p>
