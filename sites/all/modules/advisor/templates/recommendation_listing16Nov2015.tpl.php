   ...
   <div class="user-banner"><img src="<?php echo $base_url . '/' . drupal_get_path('theme', $GLOBALS['theme']) ?>/images/user/user-profile.jpg" alt=" ">
             <?php 
                                if ($userDetails->picture != "") {
                                   ...
                                   print '<div class="user-name"><img style="width:150px; height:150px; border-radius:80px;" class="img-circle size-img" src="' . image_style_url($style, $imgpath) . '" alt="display pic">';
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?php 
                                ...
                                echo date_format($from_date,"M d").'-'.date_format($to_date,"M d").','.date_format($to_date,'Y');
                            ?>       
                            </td>
                            <td><?php 
