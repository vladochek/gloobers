...
if (!empty($requestlist)) {
    ...
    foreach ($requestlist as $request) {
        ...
        //echo "<pre>";print_r($traveller);die;
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td rowspan="2">
                                        ...
                                        <a href="<?php  echo $base_url.'/profile/'.$request['uid']; ?>" target="_blank" > 
                                    ...
                                    <td><?php if(empty($request['from_date']) && empty($request['to_date'])){
                                        echo "N.A";
                                    } else{

                                    echo date("M d", strtotime($request['from_date'])) .', '. date("Y", strtotime($request['from_date'])); } ?></td>
                                    ...
                                    <?php } else if ($request['status'] == 0) { ?>
                                        ...
                                        <td class="red"><?php echo 'CLOSED'; ?></td>

                                    <?php } else { ?>

                                        <td class="red"><?php echo 'DECLINED'; ?></td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><div class="req_decline">Until <?php if(empty($request['to_date'])){echo "N.A"; }else{echo date("M d", strtotime($request['to_date'])).', '.date("Y", strtotime($request['to_date']));} ?> <br> 

                                            <?php if ($request['status'] == 1) { ?>

                                                <a href="javascript:void(0)" onclick="decline_request('<?php echo base64_encode($request['rid']); ?>', '<?php echo $request['first_name']; ?>')">Decline  this request</a> </div></td>
...
//echo "<pre>";Print_r($mutualStore);exit;
                                                    foreach ($mutualStore as $passion) {
                                                        ...
                                                        if (file_exists($base_url . '/' . drupal_get_path('theme', $GLOBALS['theme']).'/images/passion/'.$imageSrcPassion)) {
...
<section class="recv_list">
    <div class="dr-wrapper">
        <div class="map-search">
            <div class="row">
                <div class="sidebar">
                    <div class="listsection reciverequestclass" id="rocommendation_<?php echo $request['traveller_uid']; ?>"> </div>
                </div>
            </div>
        </div>
    </div>
