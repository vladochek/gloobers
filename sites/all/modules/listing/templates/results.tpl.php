...
<input type="search" name="search_desti" id="search_keyword" value="<?php echo arg(1); ?>" class="desinput" onKeyup="search_destination();" onblur="if (this.placeholder == ''){this.placeholder = 'Enter a destination'; }" onfocus="if(this.placeholder == 'Enter a destination'){this.placeholder = '';}" autocomplete="off" type="text" placeholder="Enter a destination"  />
                                    ...
                                    <div class="flexslider">
                                        <ul class="slides">
                                            ...
                                            if (count($photos) > 0) {
                                                ...
                                                <li>
                                                    <a href="<?php print $base_url; ?>/experience/<?php echo $listing["eid"] . $offerUriParam; ?>" >
                                                        <img src="<?php print base_path() . drupal_get_path('theme', 'gloobers_new'); ?>/images/cover_small_pic.jpg" alt="place" />
                                                    </a>
                                                </li>							
                                                <?php
                                            }
...
<li><div class="recommendbutton">
<a href="javascript:void(0);" onclick="recommendfn(<?php echo $listing["eid"];?>)"><i class="fa fa-plus"></i>Recommend to friend</a>
</div> <!-- End RecommendButton --></li>
...
jQuery(".listicon").click(function(event){
    ...
    var setFilter = function (obj) {
		if(obj.selectedStar){ var selectedstar=obj.selectedStar;}else{var selectedstar='';}
        var data = {'min': obj.min, 'max': obj.max, 'action': obj.action, type: 'my_listing', 'page': '<?php echo $_GET['page']; ?>',selectedstar:selectedstar};
