...
<h2 class="pagehead"><?php if($_GET['booking_status']=='upcoming_reservation'){ echo 'Upcoming reservations'; }else {echo 'Reservation history';} ?></h2>
...
<div class="col-lg-12">
 ...
 <div class="main-box clearfix">
	...
	<div class="main-box-header clearfix">
		<h2 class="pull-left">Booking Details (<?php echo $bookingsCount; if($_REQUEST['booking_status']=='upcoming_reservation') { echo " Upcoming reservations"; }else{ echo " Past reservations";}?>)</h2>
	</div>
				  ...
				  ?>
					...
					<td><?php echo $i;?></td>
                     ...
                     <!-- <td style="width: 15%;" class="text-right"><a class="table-link inline" href="#details<?php echo $booking['id'];?>"> <span class="fa-stack"> <i class="fa fa-square fa-stack-2x"></i> <i class="fa fa-eye fa-stack-1x fa-inverse"></i> </span> </a></td>-->
					  ...
					  <td style="width: 15%;" class="text-right"><a class="table-link inline" href="#details<?php echo $booking['id'];?>"> View booking details  </a></td>
...
<!-- Resrvation pop HTML start here --> 
 ...
 <div class="reservation_popup_title">
  ...
  <div class="reservation_popup_title_left col-sm-2"> <h4><?php //echo $booking['booking_id']; ?></h4> </div>
 ...
 // echo "<pre>";Print_r($photosData);exit;
  ...
  if(!empty($OverviewData['main_img_fid'])){ ?>
		...
		<img  src="<?php print image_style_url($reservation_popup_listing_img, $imgpath); ?>" onerror="this.onerror=null;this.src='<?php echo $base_url . '/' . drupal_get_path('theme', 'gloobers_new') . '/images/default_images/banner-thumb_img.jpg'; ?>'" alt="place" onerror="this.onerror=null;this.src='<?php echo $base_url . '/' . drupal_get_path('theme', 'gloobers_new') . '/images/default_images/banner-thumb_img.jpg'; ?>'"  />
  ...
  <div class="col-md-12">
      <div class="reservation_contact_inner">
       <h5>Cancellation policy</h5>
		...
		?>
       <p class="text-center"><b><?php echo $policyType.'</b>'.$policyinfo;?></p>
      </div>
    </div>
 </div>
</div>
...
<div class="additional_services_inner">
	 ...
	 <?php                         
 						...
 						<?php
                            ...
                            <div class="col-xs-3 col-sm-2">
							<p>$<?php echo $booking['total_cost'];?></p> 
                            </div>
							<div class="col-xs-9 col-sm-10">
                                <p>Gloobers services tax:</p>
							</div>
                            <div class="col-xs-3 col-sm-2">
								<p>$<?php echo $booking['service_tax'];?></p> 
                            </div>
