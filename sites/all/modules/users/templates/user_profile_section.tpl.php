...
foreach ($passeports as $key => $value) {
  ...
  if($value['description']){$description[] = $value['description'];}
...
?>
 <div id="notifications" class="success_notification" style="display:none"><div class="alert alert-success" >Successfully Added</div></div>
...
<div class="cover_image">
	<div class="simple-cropper-images cover_img" >
		  <div class="cropme" id="cp" <?php if(!empty($cover_pic)){ ?>style="background-image:url('<?php $style="cover_pic"; print image_style_url($style, $cover_pic);?>')"<?php } ?>>
<div class="profile_text">	<img src="<?php print $GLOBALS['base_url'].'/'. drupal_get_path('theme',$GLOBALS['theme']); ?>/images/cover.png" alt="image"> <br/>Change the cover picture</div>
</div>
</div>
    ...
    <div class="simple-cropper-images profile_pic">
      <div class="cropme" id="dp">
      	<div class="overlaytext">
			<div class="overprofile_text">
				<img src="<?php print $GLOBALS['base_url'].'/'. drupal_get_path('theme',$GLOBALS['theme']); ?>/images/cover.png" alt="image">
	  ...
	  <?php		$style = "reservation_popup_listing_img"; print '<img class="" src="' . image_style_url($style, $profile_pic) . '" alt="display pic">';
...
placeholder="Introduce yourself to the tribe, share your best travel souvenirs, the friendly local you won't forget or any other element that you want to let other travelers know about you"><?php if(!empty($Main_user_data[0]['about_yourself'])){echo $Main_user_data[0]['about_yourself']; } ?></textarea>
...
<input type="text" autocomplete="off" value="<?php if(!empty($loc)){echo $loc;} ?>" onclick="hometowngeocode();" id="home-town" onblur="add_hometown()" placeholder="Enter your hometown" class="hometown" name="tags5">
</div>
</div>
...
<h3>Occupation</h3>
<div class="col-md-12 col-sm-12 col-xs-12">
<input name="Enter your occupation" id ="occupation" type="text" placeholder="Enter your occupation" onblur="add_occupation()" value="<?php if(!empty($Main_user_data[0]['occupation'])){echo $Main_user_data[0]['occupation'];} ?>">
...
<h3>Phone Number</h3>
<div class="col-md-12 col-sm-12 col-xs-12">
<input name="phonenumber" id ="phone" type="text" placeholder="Enter your phone number" onblur="add_phone_number()" value="<?php if(!empty($Main_user_data[0]['mobile'])){echo $Main_user_data[0]['mobile'];} ?>">
...
<div class="col-md-4 col-sm-4 col-xs-12"> <input type="submit" class="button pull-right" name="add"  onclick="add_language();" value="Add"/> </div>

</div>

<div id="Lang_div">
<?php 
if(!empty($select_language)){ foreach($select_language as $lang){ ?>
<span tag="Bahasa Indonesia" class="tagmanagerTag"><?php echo $lang; ?><a href="javascript:void(0);" title="Remove" onclick="Delete_language(this)" class="tagmanagerRemoveTag">x</a></span>
<?php  } } ?>
</div>
...
<div class="grid">
  <div id="owl-demo" class="owl-carousel owl-theme">
      ...
      <?php foreach ($passionlist as  $passion) { 
        ...
        ?>
          <div class="item">
          	<figure class="effect-layla"><img alt="img06" src="<?php print image_style_url($style,$imgpath); ?>">
            <figcaption>
			<?php //if($file_thumb){ ?>
...
<div class="col-md-10 col-sm-10 col-xs-12"><input name="input" id="dynamic" readonly type="text" value="<?php echo $recommendation_link; ?>"></div>
<div class="col-md-2 col-sm-2 col-xs-12">
<a class="actionbtn pull-right btnc" data-clipboard-action="copy" data-clipboard-target="#dynamic" href="javascript:void(0);">Copy</a>

</div>

<div class="col-md-12 col-sm-12 col-xs-12 socil_icon">
<div class="col-md-4 col-sm-4 col-xs-12">
<a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $recommendation_link;?>">
<i class="fa fa-facebook"></i><p>Share on Facebook </p> </a>
</div>

<div class="col-md-4 col-sm-4 col-xs-12">
<a class="" target="_blank" href="https://plus.google.com/share?url=<?php echo $recommendation_link;?>">
...
<i class="fa fa-twitter"></i><p>Share on Twitter </p> </a>
</div>
