Drupal.behaviors.views_accordion = {
  attach: function(context) {
    if(Drupal.settings.views_accordion){
      (function (jQuery) {
        jQuery.each(Drupal.settings.views_accordion, function(id) {
          /* Our view settings */
          ...
          jQuery(displaySelector + ' ' + headerSelector + ':not(.ui-accordion-header)').each(function(i){
          ...
          jQuery(displaySelector + ':not(.ui-accordion)').accordion(options);
        });
      })(jQuery);
    }
  }
